    ...
    <div className="pt-20">
      ...
      <section className="relative min-h-[45vh] flex items-center overflow-hidden">
        ...
        <div className="container-custom text-center relative z-10 w-full">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white mt-2 mb-3">خدماتنا</h1>
          <p className="text-white/80 text-base max-w-2xl mx-auto">كل ما تحتاجه سيارتك في مكان واحد</p>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 mb-8">
            <div className="flex items-center gap-2 bg-overlay/5 border border-overlay/10 rounded-full px-4 py-2">
              ...
              <span className="text-muted text-xs">اختر الخدمة المناسبة</span>
            </div>
            ...
            <div className="flex items-center gap-2 bg-overlay/5 border border-overlay/10 rounded-full px-4 py-2">
              ...
              <span className="text-muted text-xs">نخدم سيارتك باحترافية</span>
            </div>
          </div>
            ...
            {services.map((service) => (
              ...
              >
                ...
                <div className="absolute bottom-0 right-0 left-0 p-5">
                  ...
                  <p className="text-white/80 text-xs leading-relaxed line-clamp-3 mb-2">{service.description}</p>
