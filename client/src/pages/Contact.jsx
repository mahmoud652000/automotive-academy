  ...
  return (
    <div>
      ...
      <section className="relative w-full overflow-hidden">
        <img src="/contact-bg.webp" alt="تواصل معنا - Automotive Academy" className="w-full h-auto block" />
      </section>
      ...
      <section className="relative z-20 py-10 md:py-14">
        <div className="container-custom">
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <h2 className="text-heading font-bold text-lg md:text-2xl whitespace-nowrap">طرق التواصل معنا</h2>
            <span className="w-12 md:w-20 h-px bg-primary" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {contactMethods.map((method, index) => (
              ...
              >
                ...
                {/* Title */}
                <h3 className="text-heading font-bold text-sm mb-2">{method.title}</h3>

                {/* Value */}
                <p className="text-muted text-xs leading-relaxed mb-3 flex-1">{method.value}</p>
      ...
      <section className="py-16 bg-surface">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-b from-white/[0.04] to-transparent rounded-2xl p-6 md:p-8 border border-overlay/10">
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-xl md:text-2xl font-bold text-heading">أرسل لنا رسالة</h2>
                    <p className="text-faint text-xs mt-0.5">سنرد عليك في أقرب وقت ممكن</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="relative group">
                      <input type="text" placeholder="الاسم بالكامل" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} required
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    {/* Subject */}
                    <div className="relative group">
                      <input type="text" placeholder="الموضوع" value={form.subject} onChange={(e) => setForm({ ...form, subject: e.target.value })} required
                        className="w-full bg-overlay/5 border border-overlay/10 rounded-xl pr-4 pl-11 py-3 text-heading placeholder-faint focus:border-primary focus:bg-overlay/10 focus:outline-none transition-all duration-300 text-sm" />
                      <span className="absolute top-1/2 -translate-y-1/2 left-4 text-faint group-hover:text-primary group-focus-within:text-primary transition-colors duration-300">
                  ...
                  {/* Message */}
                  <div className="relative group">
                    <textarea placeholder="رسالتك" value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} required rows={5}
            ...
            <div>
              <h2 className="text-2xl font-bold text-heading mb-6">موقعنا</h2>
              <div className="rounded-xl overflow-hidden h-96 border border-overlay/10">
                <iframe src="https://maps.google.com/maps?q=31.0252126,31.3926808&z=17&hl=ar&output=embed" className="w-full h-full" style={{ border: 0 }} title="موقع أكاديمية السيارات" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-10 md:py-14 bg-surface relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-heading">فرع أكاديمية السيارات</h2>
          </div>
            ...
            {branches.map((branch, index) => (
              <div key={index} className="group relative bg-gradient-to-b from-white/[0.04] to-transparent rounded-2xl overflow-hidden border border-overlay/10 hover:border-primary/30 transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/10">
                <div className="relative h-56 md:h-72 overflow-hidden">
                  <img src={branch.image} alt={branch.name} className="w-full h-full object-cover group-hover:scale-105 transition-all duration-700" />
