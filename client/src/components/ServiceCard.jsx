    ...
    >
      ...
      <div className="absolute bottom-0 right-0 left-0 p-3 sm:p-4">
        <div className="flex items-center gap-2 mb-1">
          ...
          <h3 className="text-on-hero font-bold text-xs sm:text-sm">{service.title}</h3>
        </div>
        <p className="text-on-hero-secondary text-[10px] leading-relaxed line-clamp-2">{service.description}</p>
