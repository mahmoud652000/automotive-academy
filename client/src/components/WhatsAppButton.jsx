...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-[60] group"
      aria-label="WhatsApp"
    >
      <div className="relative">
        ...
        {/* Button */}
        <div className="relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center shadow-2xl shadow-green-500/40 group-hover:scale-110 transition-all duration-300 border-2 border-overlay/30">
          <svg
            viewBox="0 0 32 32"
